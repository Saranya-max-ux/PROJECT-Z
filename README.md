...
Python 3.x: Make sure to have the latest version for optimal performance.
Requests Library: This project relies on the Requests library for making HTTP requests. To install, run:
bash
Copy code
pip install requests
🚀 Getting Started
To quickly get your Weather Monitoring App up and running, follow these simple steps:
...
Copy code
pip install requests
Run the Application: Start the app to begin fetching live weather data:

bash
Copy code
python weather_monitor.py
Input City Names: Enter the names of the cities you wish to monitor when prompted, and receive instant weather updates.

🛠️ Usage Example
Once the app is running, you can input a city name like Delhi. The application will respond with the current temperature, humidity levels, and weather conditions, helping you make informed decisions, such as whether to carry an umbrella or dress warmly.
